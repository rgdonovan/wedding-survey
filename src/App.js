  ...
  return (
    <div className="app">
      ...
      <div className="info">
        ...
        <p className="info__text">(its a short turnaround, we know)</p>
        <nav>
          <a href="https://forms.gle/DzH5CZ1R2ZX4mm2S9">RSVP</a>
          {showGifts ? (
            <div className="gift-info">
              <p>Our tiny apartment doesn't leave much room for gifts, but we'd appreciate anything on this list: <a href="">here</a></p>
              <p>We'd also happily accept &#128184; for our honeymoon! <a href="https://venmo.com/code?user_id=2243801024299008025&created=1649459328.441108&printed=1">here</a></p>
            </div>
          ) : (
